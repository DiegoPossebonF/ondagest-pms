...
export function NimbusTransferReal(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      {/* Icon from Nimbus by Linkedstore S.A. - https://github.com/cyberalien/nimbus-icons/blob/main/LICENSE */}
      <path
        fill="currentColor"
